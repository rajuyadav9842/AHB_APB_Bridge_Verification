...
//bridge_rd_agent_config m_rd_agent_config[];
	extern function new(string name = "bridge_rd_agt_top" , uvm_component parent);
	extern function void build_phase(uvm_phase phase);
//	extern task run_phase(uvm_phase phase);
  endclass
	function bridge_rd_agt_top::new(string name = "bridge_rd_agt_top" , uvm_component parent);
